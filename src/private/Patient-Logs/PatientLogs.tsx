  ...
  const fetchData = async (date?: string) => {
    try {
      if (selectedButton === "Consultation") {
        let apiUrl =
          "http://ec2-3-111-57-33.ap-south-1.compute.amazonaws.com:8080/api/AD/getAppointmentByDate";
        ...
        let apiUrl = `http://ec2-3-111-57-33.ap-south-1.compute.amazonaws.com:8080/api/AD/getAdHocByDate?date=${date}`;
