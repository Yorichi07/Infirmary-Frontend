  ...
  const fetchData = async (date?: string) => {
    try {
      if (selectedButton === "Consultation") {
        let apiUrl =
          "http://ec2-13-201-227-93.ap-south-1.compute.amazonaws.com/api/AD/getAppointmentByDate";
        ...
        let apiUrl = `http://ec2-13-201-227-93.ap-south-1.compute.amazonaws.com/api/AD/getAdHocByDate?date=${date}`;
