  ...
  useEffect(()=>{
    ...
    const getAllData = async () => {
      ...
      try{
        ...
        const responseAllPatient = await axios.get("http://ec2-3-111-57-33.ap-south-1.compute.amazonaws.com:8080/api/analytics/geTotalPatient",{
          headers:{
      ...
      try{
        const responseSchoolWise = await axios.get("http://ec2-3-111-57-33.ap-south-1.compute.amazonaws.com:8080/api/analytics/getSchoolWise",{
          headers:{
            Authorization:`Bearer ${token}`
          }
        })
      ...
      //Get Top 10 medicine
      try{
        const responseTopMedsPres = await axios.get("http://ec2-3-111-57-33.ap-south-1.compute.amazonaws.com:8080/api/analytics/getTopMeds",{
          headers:{
            Authorization:`Bearer ${token}`
          }
        });
      ...
      try{
        const responseByResType = await axios.get("http://ec2-3-111-57-33.ap-south-1.compute.amazonaws.com:8080/api/analytics/getByResidenceType",{
          headers:{
            Authorization:`Bearer ${token}`
          }
        });
      ...
      try{
        const responseDoctorWise = await axios.get("http://ec2-3-111-57-33.ap-south-1.compute.amazonaws.com:8080/api/analytics/getByDoctorName",{
          headers:{
            Authorization:`Bearer ${token}`
          }
        });
      ...
      try{
        const responseMonthlyData = await axios.get("http://ec2-3-111-57-33.ap-south-1.compute.amazonaws.com:8080/api/analytics/getMonthlyData",{
          headers:{
            Authorization:`Bearer ${token}`
          }
        });
      ...
      try{
        const responseYearlyData = await axios.get("http://ec2-3-111-57-33.ap-south-1.compute.amazonaws.com:8080/api/analytics/getYearlyData",{
          headers:{
            Authorization:`Bearer ${token}`
          }
        });
      ...
      //Get Daily Data
      try{
        const responseDailyData = await axios.get("http://ec2-3-111-57-33.ap-south-1.compute.amazonaws.com:8080/api/analytics/getDailyData",{
          headers:{
            Authorization:`Bearer ${token}`
          }
        });
