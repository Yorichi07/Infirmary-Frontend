        ...
        if (error.response && error.response.status === 404) {
          try {
            const resBackup = await axios.get(
              "http://ec2-3-111-57-33.ap-south-1.compute.amazonaws.com:8080/api/patient/",
              {
                headers: {
                  Authorization: "Bearer " + token,
                },
    ...
    if (isValid) {
      try {
        ...
        const response = await axios.put(
          "http://ec2-3-111-57-33.ap-south-1.compute.amazonaws.com:8080/api/patient/update",
          {
            ...
            <div className="profile-container__body">
              <div className="image-container">
                <Image
                  src={
                    img != null
                      ? `http://ec2-3-111-57-33.ap-south-1.compute.amazonaws.com:8080/${img}`
                      : "/default-user.jpg"
                  }
                  preview
                  style={{
