        ...
        if (error.response && error.response.status === 404) {
          try {
            const resBackup = await axios.get(
              "http://ec2-13-201-191-145.ap-south-1.compute.amazonaws.com/api/patient/",
              {
                headers: {
                  Authorization: "Bearer " + token,
                },
    ...
    if (isValid) {
      try {
        ...
        const response = await axios.put(
          "http://ec2-13-201-191-145.ap-south-1.compute.amazonaws.com/api/patient/update",
          {
            ...
            <div className="profile-container__body">
              <div className="image-container">
                <Image
                  src={
                    img != null
                      ? `http://ec2-13-201-191-145.ap-south-1.compute.amazonaws.com/${img}`
                      : "/default-user.jpg"
                  }
                  preview
                  style={{
