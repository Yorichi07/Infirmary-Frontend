...
const UserAppointment = () => {
  ...
  useEffect(() => {
    const fetchDoctors = async () => {
      try {
        ...
        const response = await axios.get(
          "http://ec2-3-111-57-33.ap-south-1.compute.amazonaws.com:8080/api/patient/getAvailableDoctors",
          {
            headers: {
    ...
    const getUser = async () => {
      ...
      try {
        const res = await axios.get("http://ec2-3-111-57-33.ap-south-1.compute.amazonaws.com:8080/api/patient/", {
          headers: {
            Authorization: "Bearer " + token,
          },
        });
  ...
  const fetchLastAppointmentDate = async () => {
    try {
      const token = localStorage.getItem("token");
      const response = await axios.get(
        "http://ec2-3-111-57-33.ap-south-1.compute.amazonaws.com:8080/api/patient/lastAppointmentDate",
        {
          headers: {
            Authorization: "Bearer " + token,
          },
    ...
    if (isValid) {
      try {
        ...
        const response = await axios.post(
          "http://ec2-3-111-57-33.ap-south-1.compute.amazonaws.com:8080/api/patient/submitAppointment",
          appointmentData,
          {
            headers: {
              Authorization: `Bearer ${token}`,
              ...
              <img
                src={
                  userDetails.imageUrl != null
                    ? `http://ec2-3-111-57-33.ap-south-1.compute.amazonaws.com:8080/${userDetails.imageUrl}`
                    : "/default-user.jpg"
                }
