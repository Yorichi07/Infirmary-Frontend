...
const MedicineStock = () => {
  ...
  const handleSaveEdit = async () => {
    if (editStock) {
      try {
        ...
        await axios.post(
          `http://ec2-3-111-57-33.ap-south-1.compute.amazonaws.com:8080/api/${role}/stock/editStock`,
          editStock,
          {
            headers: {
  ...
  const fetchStocks = async () => {
    try {
      ...
      const response = await axios.get(
        `http://ec2-3-111-57-33.ap-south-1.compute.amazonaws.com:8080/api/${role}/stock/`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  const fetchLocations = async () => {
    try {
      const resp = await axios.get("http://ec2-3-111-57-33.ap-south-1.compute.amazonaws.com:8080/api/location/");
      if (resp.status === 200) {
  ...
  const handleDownloadExcel = async () => {
    try {
      ...
      const response = await axios.get(
        `http://ec2-3-111-57-33.ap-south-1.compute.amazonaws.com:8080/api/${role}/export`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  const handleSave = async () => {
    if (newStock) {
      try {
        ...
        await axios.post(
          `http://ec2-3-111-57-33.ap-south-1.compute.amazonaws.com:8080/api/${role}/stock/addStock`,
          formattedNewStock,
          {
            headers: {
              Authorization: `Bearer ${token}`,
  ...
  const handleDelete = async () => {
    ...
    for (const batchNumber of selectedStocks) {
      try {
        await axios.delete(
          `http://ec2-3-111-57-33.ap-south-1.compute.amazonaws.com:8080/api/${role}/stock/${batchNumber}`,
          {
            headers: {
              Authorization: `Bearer ${token}`,
            },
