    ...
    const fetchMedicineStock = async () => {
      try {
        const response = await axios.get(
          "http://ec2-3-111-57-33.ap-south-1.compute.amazonaws.com:8080/api/AD/stock/available",
          {
            headers: {
  ...
  const handleSubmit = async (data: any) => {
    ...
    try {
      ...
      const response = await axios.post(
        "http://ec2-3-111-57-33.ap-south-1.compute.amazonaws.com:8080/api/AD/submit/adHoc",
        submitData,
        {
          headers: {
            Authorization: `Bearer ${localStorage.getItem("token")}`,
