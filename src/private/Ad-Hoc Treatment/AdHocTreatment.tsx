    ...
    const fetchMedicineStock = async () => {
      try {
        const response = await axios.get(
          "http://ec2-13-201-227-93.ap-south-1.compute.amazonaws.com/api/AD/stock/available",
          {
            headers: {
  ...
  const handleSubmit = async (data: any) => {
    ...
    try {
      ...
      const response = await axios.post(
        "http://ec2-13-201-227-93.ap-south-1.compute.amazonaws.com/api/AD/submit/adHoc",
        submitData,
        {
          headers: {
            Authorization: `Bearer ${localStorage.getItem("token")}`,
