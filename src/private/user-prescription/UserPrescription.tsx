    ...
    const fetchData = async () => {
      try {
        ...
        if (role !== "patient") {
          ...
          apiUrl = `http://ec2-3-111-57-33.ap-south-1.compute.amazonaws.com:8080/api/doctor/getAppointmentPat/${emailSent}`;
        } else {
          apiUrl = "http://ec2-3-111-57-33.ap-south-1.compute.amazonaws.com:8080/api/patient/getAppointment";
        }
        ...
        const formatData = response.map((rept: any) => ({
          ...
          date: rept.date,
          token: rept.token,
          downloadLink: `http://ec2-3-111-57-33.ap-south-1.compute.amazonaws.com:8080/prescription?id=${rept.appointmentId}`,
        }));
