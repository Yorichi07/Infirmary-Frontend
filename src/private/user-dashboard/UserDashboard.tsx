...
const UserDashboard = () => {
  ...
  useEffect(() => {
    ...
    const getMedicalDetailsStatus = async () => {
      ...
      try {
        const res = axios.get(
          "http://ec2-3-111-57-33.ap-south-1.compute.amazonaws.com:8080/api/patient/getAllDetails",
          {
            headers: {
    ...
    const getStatus = async () => {
      ...
      try {
        const response = await axios.get(
          "http://ec2-3-111-57-33.ap-south-1.compute.amazonaws.com:8080/api/patient/getStatus",
          {
            headers: {
              Authorization: "Bearer " + token,
            },
