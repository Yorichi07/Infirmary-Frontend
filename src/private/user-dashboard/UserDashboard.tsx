...
const UserDashboard = () => {
  ...
  useEffect(() => {
    ...
    const getMedicalDetailsStatus = async () => {
      ...
      try {
        const res = axios.get(
          "http://ec2-13-201-191-145.ap-south-1.compute.amazonaws.com/api/patient/getAllDetails",
          {
            headers: {
    ...
    const getStatus = async () => {
      ...
      try {
        const response = await axios.get(
          "http://ec2-13-201-191-145.ap-south-1.compute.amazonaws.com/api/patient/getStatus",
          {
            headers: {
              Authorization: "Bearer " + token,
            },
