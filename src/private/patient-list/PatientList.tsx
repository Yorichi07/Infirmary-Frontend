      ...
      try {
        ...
        const url =
          selectedButton === "Pending"
            ? "http://192.168.0.107:8081/api/AD/getPatientQueue"
            : "http://192.168.0.107:8081/api/AD/getCompletedQueue";
  ...
  const getAppointmentDetails = async (email: string) => {
    ...
    try {
      ...
      const response = await axios.get(
        `http://192.168.0.107:8081/api/AD/getAptForm/${email}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await axios.post(
        "http://192.168.0.107:8081/api/AD/submitAppointment",
        {
                                  ...
                                  <button
                                    ...
                                    onClick={async () => {
                                      try {
                                        ...
                                        const response = await axios.get(
                                          `http://192.168.0.107:8081/api/AD/rejectAppointment?email=${pat.email}`,
                                          {
                                            headers: {
                                              Authorization: `Bearer ${token}`,
                                            },
                          ...
                          onClick={async () => {
                            try {
                              const resp = await axios.get(
                                `http://192.168.0.107:8081/api/AD/completeAppointment/${pat.email}`,
                                {
                                  headers: {
