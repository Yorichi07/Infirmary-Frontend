...
const PatientList = () => {
    ...
    try {
      ...
      const url =
        selectedButton === "Pending"
          ? "http://ec2-13-126-247-225.ap-south-1.compute.amazonaws.com/api/AD/getPatientQueue"
          : selectedButton === "Assigned" ? "http://ec2-13-126-247-225.ap-south-1.compute.amazonaws.com/api/AD/getAssignedPatient" : "http://ec2-13-126-247-225.ap-south-1.compute.amazonaws.com/api/AD/getCompletedQueue";
  ...
  const getAppointmentDetails = async (email: string) => {
    ...
    try {
      ...
      const response = await axios.get(
        `http://ec2-13-126-247-225.ap-south-1.compute.amazonaws.com/api/AD/getAptForm/${modifiedEmail}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  const fetchAvailableDoctors = async () => {
    try {
      ...
      const response = await axios.get(
        "http://ec2-13-126-247-225.ap-south-1.compute.amazonaws.com/api/AD/getAvailableDoctors",
        {
          headers: {
            Authorization: `Bearer ${token}`,
            "X-Latitude": localStorage.getItem("latitude"),
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await axios.post(
        "http://ec2-13-126-247-225.ap-south-1.compute.amazonaws.com/api/AD/submitAppointment",
        {
  ...
  const handleRejectAppointment = async (email: string) => {
    try {
      const token = localStorage.getItem("token");
      const response = await axios.get(
        `http://ec2-13-126-247-225.ap-south-1.compute.amazonaws.com/api/AD/rejectAppointment?email=${email}`,
        {
  ...
  const handleCompleteAppointment = async (email: string) => {
    try {
      const token = localStorage.getItem("token");
      const response = await axios.get(
        `http://ec2-13-126-247-225.ap-south-1.compute.amazonaws.com/api/AD/completeAppointment/${email}`,
        {
          headers: { Authorization: `Bearer ${token}` },
        }
      );
                                    ...
                                    <button
                                      ...
                                      onClick={async () => {
                                        try {
                                          ...
                                          const response = await axios.get(
                                            `http://ec2-13-126-247-225.ap-south-1.compute.amazonaws.com/api/AD/rejectAppointment?email=${pat.email}`,
                                            {
                                              headers: {
                                                Authorization: `Bearer ${token}`,
                                              },
