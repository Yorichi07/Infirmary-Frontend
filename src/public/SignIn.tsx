...
const API_URLS = {
  patient: "http://ec2-3-111-57-33.ap-south-1.compute.amazonaws.com:8080/api/auth/patient/signin",
  doctor: "http://ec2-3-111-57-33.ap-south-1.compute.amazonaws.com:8080/api/auth/doctor/signin",
  nursing_assistant: "http://ec2-3-111-57-33.ap-south-1.compute.amazonaws.com:8080/api/auth/ad/signin",
};
  ...
  const handlePassChange = async (data: any) => {
    ...
    try {
      const response = await axios.get(
        `http://ec2-3-111-57-33.ap-south-1.compute.amazonaws.com:8080/api/auth/passwordChangeRequest?email=${emailSent}&role=${passRole}`
      );
