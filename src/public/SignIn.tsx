...
const API_URLS = {
  patient: "http://ec2-13-201-191-145.ap-south-1.compute.amazonaws.com/api/auth/patient/signin",
  doctor: "http://ec2-13-201-191-145.ap-south-1.compute.amazonaws.com/api/auth/doctor/signin",
  nursing_assistant: "http://ec2-13-201-191-145.ap-south-1.compute.amazonaws.com/api/auth/ad/signin",
};
  ...
  const handlePassChange = async (data: any) => {
    ...
    try {
      const response = await axios.get(
        `http://ec2-13-201-191-145.ap-south-1.compute.amazonaws.com/api/auth/passwordChangeRequest?email=${emailSent}&role=${passRole}`
      );
